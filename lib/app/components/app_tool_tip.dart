...
class TooltipState extends State<Tooltip> with SingleTickerProviderStateMixin {
  ...
  bool ensureTooltipVisible() {
    ...
    if (_isConcealed) {
      if (_mouseIsConnected) {
        AppToolTip._concealOtherTooltips(this);
      }
      _revealTooltip();
      return true;
    }
  ...
  void _createNewEntry() {
    ...
    assert(!AppToolTip._openedTooltips.contains(this));
    AppToolTip._openedTooltips.add(this);
  }

  void _removeEntry() {
    AppToolTip._openedTooltips.remove(this);
